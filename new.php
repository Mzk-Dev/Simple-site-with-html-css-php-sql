        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="content-container col-md-10 col-lg-10">
                    <h1 class="text-center py-2">New post</h1>
                    ...
                    <form action="action_new.php" method="POST">
                        <div class="form-group col-8 m-auto py-3">
                            ...
                            <input type="text" class="form-control" id="textinput" name="Name" placeholder="Enter your Name">
                        </div>
                        <div class="form-group col-8 m-auto py-3">
                            <label for="textareainput">Description</label>
                            <textarea class="form-control" id="textareainput" rows="3" name="Desc" placeholder="Random text"></textarea>
                        </div>
